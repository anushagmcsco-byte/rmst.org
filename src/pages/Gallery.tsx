...
const PHOTO_GALLERY: PhotoItem[] = [
  {
    ...
    date: 'May 2026',
    photographer: 'Ramesh K.',
    desc: 'Empowering local smallholders to maintain steady crop hydration during dry spells using modular solar pumps and targeted drip arrays.'
  },
  {
    id: 'photo_2',
    ...
    location: 'Yaraguppi, Kundgol',
    date: 'April 2026',
    photographer: 'Anita Patel',
    desc: 'Women self-help group leaders organizing milk collection registers and tracking quarterly dividend payouts for community dairy units.'
  },
  {
    id: 'photo_3',
    ...
    location: 'Kundgol High School, Dharwad',
    date: 'June 2026',
    photographer: 'Vikram S.',
    desc: 'STEM mentoring camps introducing computational thinking, basic syntax, and algorithmic logic to young students in rural state schools.'
  },
  {
    id: 'photo_4',
    ...
    date: 'March 2026',
    photographer: 'Dr. G. Rao',
    desc: 'General preventive healthcare and nutritional evaluations conducted inside remote forest villages via our diagnostic medical vans.'
  },
  {
    id: 'photo_5',
    ...
    date: 'June 2026',
    photographer: 'P. Deshpande',
    desc: 'Community volunteers creating deep soil bunds and planting intensive windbreak species to check rapid run-off and erosion.'
  },
  {
    id: 'photo_6',
    ...
    location: 'Haveri Rural, Haveri',
    date: 'May 2026',
    photographer: 'Ramesh K.',
    desc: 'Local micro-enterprises run by trained youth bagging and sealing high-nutrition organic ragi and foxtail millets for regional hubs.'
  },
  {
    id: 'photo_7',
    category: 'Events',
    ...
    location: 'Hubballi Training Centre, Dharwad',
    date: 'June 2026',
    photographer: 'Vikram S.',
    desc: 'Vetted agronomists and organic practitioners engaging over 200 farmers on zero-budget microbial soil formulation and composting.'
  },
  {
    id: 'photo_8',
    category: 'Agriculture',
    ...
    date: 'May 2026',
    photographer: 'Anita Patel',
    desc: 'Successful harvest of high-yield chili and marigold fields, intercropped to mitigate standard rainfed pest vulnerabilities.'
  }
];
      ...
      <section className="py-20 max-w-7xl mx-auto px-4" id="photo-gallery-sec">
        ...
        {filteredPhotos.length === 0 && (
          <div className="py-12 text-center text-slate-400 font-mono">
            No logged photographs found for this category category.
          </div>
        )}
      </section>

                      ...
                      <div className="h-60 w-full pt-2">
                        <ResponsiveContainer width="100%" height="100%">
                          <BarChart data={SDG_MAPPING_DATA} layout="vertical" margin={{ left: -10, right: 10 }}>
                            <XAxis type="number" fontSize={10} fontClassName="font-mono" />
                            <YAxis dataKey="name" type="category" width={110} fontSize={9} fontClassName="font-mono" />
                    ...
                    <div className="h-64 w-full pt-2">
                      <ResponsiveContainer width="100%" height="100%">
                        <LineChart data={YEAR_OVER_YEAR_GROWTH} margin={{ left: -15, right: 10 }}>
                          <XAxis dataKey="year" stroke="#94a3b8" fontSize={10} fontClassName="font-mono" />

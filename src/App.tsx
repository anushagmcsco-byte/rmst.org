...
import ImpactStories from './views/ImpactStories';
import ComplianceHub from './views/ComplianceHub';
...
import MediaPress from './views/MediaPress';
import ResourceCentre from './views/ResourceCentre';
import FaqCentre from './views/FaqCentre';
...
import ImpactStoryDetail from './views/ImpactStoryDetail';
